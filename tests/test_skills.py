...
SCRIPTS = Path(__file__).parents[1] / "src" / "dcc_mcp_premiere" / "skills" / "premiere-project" / "scripts"
...
def test_project_skills_use_typed_premiere_facade():
    ...
    project = SimpleNamespace(name="Demo", active_sequence=sequence, sequences=[sequence], save=mock.Mock())
